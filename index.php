...
<div class="container">
    ...
    switch($EscolherPrato_php){
        case 'Vegetariano';
                ...
                echo "<p style=color:yellow;>O Total de Calorias é de :</p> " . $TotalCalorias_Prato_php . "<p style=color:white;> CaL</p>";
        break;
    ...
    switch($EscolherSobremesa_php){
        case 'Abacaxi';
            ...
            echo "<p style=color:yellow;>O Total de Calorias é de :</p> " . $TotalCalorias_Sobremesa_php . "<p style=color:white;> CaL</p>";
        break;
    ...
    switch($EscolherBebida_php){
        case 'Cha';
            ...
            echo "<p style=color:yellow;>O Total de Calorias é de :</p> " . $TotalCalorias_Bebida_php . "<p style=color:white;> CaL</p>";
        break;
